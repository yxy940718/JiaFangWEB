...
public class HTAlterHomeAction extends ActionSupport {
	...
	public String execute() throws Exception {
		...
		//boolean b=u.HTAddHome(leibie, homename, where, shi, ting, wei, chu, che, yang, niandai, mianji, zhuangxiu, chaoxiang, homeleixing, photo, administratorid,price,louceng);
	     boolean b=u.HTAlterHome(leibie, homename, where, shi, ting, wei, chu, che, yang, niandai, mianji, zhuangxiu, chaoxiang, homeleixing, photo, administratorid, price, louceng, homeid,xiaoqu,zhoubian,jiaotong);
		if(b){

...
public class HTAddLeaedHomeAction extends ActionSupport {
...
//	String mianji,String zhuangxiu,String chaoxiang,String homeleixing,String photo
	...
	public String execute() throws Exception {
		...
		boolean b=u.HTAddLeaedHome(leibie, homename, where, shi, ting, wei, chu, che, yang, niandai, mianji, zhuangxiu, chaoxiang, homeleixing, photo, administratorid,price,louceng,xiaoqu,zhoubian,jiaotong);
	   if(b){

  ...
  <div class="container">
    <div class="row">
      <div class="col-md-8 col-sm-12 col-xs-12">
        ...
        <div class="row">
        <struts:iterator value="pagecollectionHome" var="HomeList">
          <div class="col-sm-6">
            <div class="property_item heading_space">
                   <div class="image">
             <a href='property_detail.action?homeid=<struts:property value="#HomeList.homeid"/>'><img style="width:358px;height:284px" src="<struts:property value="#HomeList.photo.split('&&')[1]"/>" alt="latest property" class="img-responsive"></a>
      ...
      <div class="text-center">
		<c:if test="${pageNos>1 }">
			<a href="collectionlist.action?username=<struts:property value="#session.username" />&pageNo=1">首页</a>
			<a href="collectionlist.action?username=<struts:property value="#session.username" />&pageNo=${pageNos-1 }">上一页</a>
		</c:if>
		<c:if test="${pageNos <recordCount }">
			<a href="collectionlist.action?username=<struts:property value="#session.username" />&pageNo=${pageNos+1 }">下一页</a>
			<a href="collectionlist.action?username=<struts:property value="#session.username" />&pageNo=${recordCount }">末页</a>
		</c:if>
	</div>
	<form action="collectionlist.action">
		<h4 align="center">
		<input type="hidden" value="<struts:property value="#session.username" />"/>
      ...
      <aside class="col-md-4 col-xs-12">
        ...
        <struts:iterator value="collectionLeaseListlxq" var="hlx">
        ...
        <struts:iterator value="collectionSaleListlxq" var="hlx">
        <div class="row bottom20">
          <div class="col-md-4 col-sm-4 col-xs-6 p-image">
            <img src='<struts:property value="#hlx.photo.split('&&')[1]"/>' alt="image" style="width:80px;height:77px"/>
          </div>

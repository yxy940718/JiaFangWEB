  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <form action="/Flink/checkAll" method="post" >
        ...
        <ol class="breadcrumb">
          <li><a href="add-Leasedhome.jsp">添加已出租房源</a></li>
        </ol>
        ...
        <div class="table-responsive">
          <table class="table table-striped table-hover">
                ...
                if(window.confirm("此操作不可逆，是否确认？"))
			{
                ...
                if(data=="删除成功"){
              $(location).attr('href', 'selectLeaedlist.action');
                return;
                }else{
                   alert(data);
                }
               ...
               window.location.href="SelectLeaedHomeDeiltus.action?homeid="+val;
            }               
              </script>
            </tbody>
          </table>

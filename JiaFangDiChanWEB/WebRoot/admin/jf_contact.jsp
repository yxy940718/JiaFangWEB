  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <form action="/Article/checkAll" method="post" >
        <h1 class="page-header">内容 <span class="badge">3</span></h1>
        <div class="table-responsive">
          <table class="table table-striped table-hover">
            ...
            <tbody>
            <struts:iterator value="listcontant" var="lc">
              <tr>
                <td><input type="checkbox" class="input-control" name="checkbox[]" value="" /></td>
                <td class="article-title"><struts:property value="#lc.person"/></td>
                <td><struts:property value="#lc.phone"/></td>
                <td><a href="selectlContantDEILTUS.action?cid=<struts:property value="#lc.id"/>">查看</a> <a href="#" onclick="deletecontant('<struts:property value="#lc.id"/>')">删除</a></td>
              </tr>
              </struts:iterator>
            </tbody>
          </table>
...
<script>
	...
	function deletecontant(val){
	
			if(window.confirm("此操作不可逆，是否确认？"))
			{$.ajax({
                cache: true,
                type: "POST",
                url:"deletecontantAction.action",
                data:{"did":val},
                async: false,
                dataType:"html",
                ...
                if(data=="删除成功"){
               window.location.href="selectlContantAction.action";
                return false;
                }else{
                   alert(data);
                }
